...
SELECT
  ...
  CASE u.email
    WHEN 's01@test.kr' THEN 'MK'
    WHEN 's02@test.kr' THEN 'MJ'
    WHEN 's03@test.kr' THEN 'MW'
    WHEN 's04@test.kr' THEN 'ES'
    WHEN 's05@test.kr' THEN 'EK'
    WHEN 's06@test.kr' THEN 'HM'
    WHEN 's07@test.kr' THEN 'HW'
    WHEN 's08@test.kr' THEN 'DM'
